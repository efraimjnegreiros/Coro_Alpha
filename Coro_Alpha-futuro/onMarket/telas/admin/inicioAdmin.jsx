...
const data = new Date(m.dataNascimento + 'T00:00:00');
...
const estilos = StyleSheet.create({
  ...
  tituloSecao: { fontSize: 18, fontWeight: 'bold', marginBottom: 10, color: cores.texto },
  ...
  nomeAniversariante: { marginLeft: 8, fontWeight: 'bold', color: '#444' },
