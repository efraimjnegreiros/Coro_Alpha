...
//       const data = new Date(m.dataNascimento + 'T12:00:00');
...
//   // ✅ CORRIGIDO — uso correto de usuario.dataNascimento e bug do m removido
...
//     const data = new Date(usuario.dataNascimento + 'T12:00:00');
...
//     const dados = { nome, tipo, naipe, dataNascimento: dataISO };

//     try {
//       if (modoEdicao && usuarioSelecionado) {
//         await axios.put(
//           `https://coro-alpha.onrender.com/api/usuarios/${usuarioSelecionado.id}`,
//           dados
//         );
...
//         <Text style={estilos.tituloSecao}>Aniversariantes do mês 🎉</Text>
//         {carregando ? (
//           <Text>Carregando...</Text>
//         ) : aniversariantes.length === 0 ? (
//           <Text style={estilos.textoInfo}>Nenhum aniversariante neste mês.</Text>
//         ) : (
...
//               const dia = String(data.getDate()).padStart(2, '0');
//               return (
//                 <View key={m.id} style={estilos.itemAniversariante}>
//                   <MaterialIcons name="cake" size={20} color="#ff6f61" />
//                   <Text style={estilos.nomeAniversariante}>
//                     {m.nome} — dia {dia}
//                   </Text>
//                 </View>
//               );
...
//         <Text style={[estilos.tituloSecao, { marginTop: 20 }]}>Membros:</Text>
...
//               {modoEdicao ? 'Editar Membro' : 'Novo Membro'}
//             </Text>
...
//   textoInfo: { color: '#777', marginBottom: 10 },

//   // 🎂 estilo dos aniversariantes
//   itemAniversariante: {
//     flexDirection: 'row',
//     alignItems: 'center',
...
<ScrollView
  ...
  style={estilos.filtroHorizontal}
>
  {[
    ...
    <TouchableOpacity
      ...
      style={[
        estilos.botaoFiltro,
        filtroSelecionado === item.value && estilos.botaoFiltroAtivo,
      ]}
      onPress={() => setFiltroSelecionado(item.value)}
    >
      <Text
        style={[
          estilos.textoFiltro,
          filtroSelecionado === item.value && estilos.textoFiltroAtivo,
        ]}
      >
        {item.label}
      </Text>
