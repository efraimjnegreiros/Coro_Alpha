const iconeEmail = require("../../imgs/adicionar.png"); 
...
export default function EnsaiosADM() {
  ...
  function abrirModalEditar(ensaio) {
    ...
    setMusicas(
      Array.isArray(ensaio.musicas) ? ensaio.musicas.join(', ') : ensaio.musicas || ''
    );
    setModoEdicao(true);
    setModalVisivel(true);
  }
  ...
  return (
    <SafeAreaView style={estilos.container}>
      ...
      {/* BOTÃO FLUTUANTE (imagem adicionar.png) */}
