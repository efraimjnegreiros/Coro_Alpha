...
<Text style={estilos.dataHoraDestaque}>📅 {e.data} • ⏰ {e.hora}</Text>
            ...
            return (
              ...
              >
                ...
                <Text style={estilos.statusEnsaio}>Seu status: {statusTexto}</Text>
                  ...
                  <MenuInferiorCliente navigation={navigation} currentScreen="Inicio" />
...
const estilos = StyleSheet.create({
  ...
  fontSize: 14,
  fontWeight: "bold",
  color: cores.Secundaria, // COR CHAMATIVA
  marginTop: 3,
},
